...
<img className="iconsimg" src={iconGitHub} alt="githublogo.png" /></a></button>

<button title="salesforce" className="buttonLinksbtn"><a href="https://trailblazer.me/id/dmsarmiento" target="_blank" rel="noopener noreferrer">
<img className="iconsimg" src={iconSalesforce} alt="salesforceicon.png" /></a></button>

{/* <button className="resumebtn" onClick={props.modalResumeClick}>
Resume</button> */}

<a href="https://drive.google.com/file/d/1F8xbd5ECovW-Psw51l6V2b9uUZ_N8B3v/view?usp=sharing" target="_blank" rel="noopener noreferrer"><button className="resumebtn">Resume</button></a>
